package c346.rp.edu.sg.demonotification;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1 = findViewById(R.id.btnNotifi1);
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                    NotificationChannel channel = new NotificationChannel("defaul", "Default Channel", NotificationManager.IMPORTANCE_DEFAULT);
